...
export function ProjectRow({ project, maxStack }: Props) {
  ...
  return (
    <Link
      ...
      className="group grid grid-cols-[110px_1fr] gap-6 py-5 -mx-4 px-4 rounded-lg border-l-2 border-transparent hover:bg-bg-elev/70 hover:border-white/25 transition-colors"
    >
